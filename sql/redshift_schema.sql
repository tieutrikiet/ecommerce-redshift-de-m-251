...
CREATE TABLE consumers (
    ...
    total_spent NUMERIC(12,4) DEFAULT 0.00 ENCODE ZSTD,
...
CREATE TABLE sellers (
    ...
    introduction VARCHAR(500) ENCODE ZSTD,
    ...
    total_sales NUMERIC(14,4) DEFAULT 0.00 ENCODE ZSTD,
    total_orders INTEGER DEFAULT 0 ENCODE ZSTD,
...
CREATE TABLE seller_vertical (
    ...
    -- Note: FK constraints removed for flexible COPY operations
    -- Referential integrity enforced at application/ETL layer
    -- FOREIGN KEY (seller_id) REFERENCES sellers(id)
    -- FOREIGN KEY (vertical_id) REFERENCES verticals(id)
)
DISTSTYLE ALL;

COMMENT ON TABLE seller_vertical IS 'Many-to-many relationship between sellers and verticals (FK constraints removed for data loading flexibility)';
...
CREATE TABLE address_books (
    ...
    country VARCHAR(60) NOT NULL ENCODE BYTEDICT,
...
CREATE TABLE commodities (
    ...
    price NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    cost_price NUMERIC(10,4) ENCODE ZSTD,
    ...
    weight_kg NUMERIC(8,4) ENCODE ZSTD,
    description TEXT ENCODE ZSTD,
    ...
    UNIQUE (sku),
    FOREIGN KEY (seller_id) REFERENCES sellers(id)
    -- Note: vertical_id FK constraint removed for flexible COPY operations
    -- FOREIGN KEY (vertical_id) REFERENCES verticals(id)
)
DISTKEY (seller_id)
SORTKEY (vertical_id, created_at);

COMMENT ON TABLE commodities IS 'Product catalog with inventory and seller information (vertical FK removed for data loading flexibility)';
...
CREATE TABLE orders (
    ...
    delivery_country VARCHAR(60) NOT NULL ENCODE BYTEDICT,
    delivery_latitude NUMERIC(10,7) ENCODE ZSTD,
    delivery_longitude NUMERIC(10,7) ENCODE ZSTD,
    subtotal_amount NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    tax_amount NUMERIC(10,4) DEFAULT 0.00 ENCODE ZSTD,
    shipping_fee NUMERIC(10,4) DEFAULT 0.00 ENCODE ZSTD,
    discount_amount NUMERIC(10,4) DEFAULT 0.00 ENCODE ZSTD,
    total_amount NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    created_at TIMESTAMP ENCODE ZSTD,
...
CREATE TABLE order_commodities (
    ...
    unit_price NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    unit_cost NUMERIC(10,4) ENCODE ZSTD,
    line_total NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    discount_applied NUMERIC(10,4) DEFAULT 0.00 ENCODE ZSTD,
...
CREATE TABLE transactions (
    ...
    amount NUMERIC(10,4) NOT NULL ENCODE ZSTD,
    status VARCHAR(20) DEFAULT 'pending' ENCODE BYTEDICT,
    created_at TIMESTAMP ENCODE ZSTD,
...
CREATE TABLE reviews (
    ...
    comment VARCHAR(500) ENCODE ZSTD,
